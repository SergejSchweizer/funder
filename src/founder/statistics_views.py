...
from founder.gold_pair_stats import DEFAULT_BUCKET_COUNT
from founder.paths import LakePaths
from founder.table_io import JsonRow, read_rows, write_json
...
def _pair_key(left: ListingKey, right: ListingKey) -> str:
    # Must match founder.bivariate_statistics._pair_key's format exactly
