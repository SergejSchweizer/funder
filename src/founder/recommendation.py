...
Compares already-computed profile candidates (`founder.profiles.evaluate_profile_candidate`
...
def build_candidate_report(
    ...
    *,
    ...
    """Build one candidate's explanation from `founder.profiles.evaluate_profile_candidate`
    output plus optional `founder.scorecard`/`founder.stress` traceability and an
